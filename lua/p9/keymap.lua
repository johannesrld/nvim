...
local function telescope(module)
  ...
  local theme
  local function _1_() return require('telescope.themes').get_ivy(opts) end
  theme = _1_
  local function _2_() return require('telescope.builtin')[module](theme()) end
  return _2_
end
keybinds {
...
keybinds {
  { noremap = true, silent = true },
  ['<leader>x'] = { 'View Problems (Focus)', _3_ },
  ['<leader>X'] = { 'View Problems', _4_ },
...
local function _5_(_241)
  return keybinds {
    { buffer = _241.buf, noremap = true, silent = true },
...
vim.api.nvim_create_autocmd(
  'LspAttach',
  vim.tbl_extend('force', {}, { callback = _5_ })
)
return nil
