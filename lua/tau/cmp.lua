...
local cmp_border = vim.tbl_deep_extend("force",
  cmp.config.window.bordered(), {
    border = {
      "\226\148\140", "\226\148\128", "\226\148\144", "\226\148\130",
      "\226\148\152", "\226\148\128", "\226\148\148", "\226\148\130"
    },
    scrollbar = false
  })
...
cmp.setup {
  ...
  formatting = {
    ...
    format = lspkind.cmp_format {
      mode = "symbol",
      maxwidth = 30,
      symbol_map = { Function = "\206\187", Method = "\198\155", Constructor = "\198\155", Field = "\226\136\136", Property = "\226\136\136", Variable = "\206\177", Snippet = "\226\141\137", Class = "C", Interface = "I", Module = "M", Enum = "E", Keyword = "K", Color = " ", File = " ", Reference = "*", Folder = " ", EnumMember = "E", Constant = "\206\177", Struct = "S", Event = " ", Operator = " ", Text = " " }, before = _8_ }
  },
  window = {
